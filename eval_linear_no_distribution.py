...
def main():
    ...
    # build data
    train_dataset = datasets.ImageFolder(os.path.join(args.data_path))
    val_dataset = datasets.ImageFolder(os.path.join(args.data_path))
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        # save checkpoint
        if epoch % 10 == 0:  # Save checkpoint periodically
            save_dict = {
                "epoch": epoch + 1,
